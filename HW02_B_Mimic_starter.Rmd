...
data("diamonds")
ggplot(diamonds, aes(cut, seq(1,53940), fill=clarity))+
...
ggplot()+
  ...
  geom_point(corvette, mapping= aes ( displ, hwy, color= 'blue'))+
  labs(title="Corvettes are a bit of an outlier", x= "displ", y="hwy")+
