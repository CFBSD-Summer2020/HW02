...
Usi()ng the iris dataset, make this graph:
```{r graph 2 code, echo=FALSE}
data("iris")

ggplot(iris, mapping = aes(x = Sepal.Length, y = Petal.Length, shape = Species, color = Species)) +
  geom_point() +
...
mpg %>%
ggplot(aes(cty, class, color = class)) +
