...
data("diamonds")
#Create a bar graph using geom_bar and specify position="dodge" to have bars side by side. Then use labs function to add labels to the graph.
