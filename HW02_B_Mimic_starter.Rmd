...
mpg %>% 
  ...
  geom_text_repel(data = corvette, aes(label = paste0("Corvette,",year)), 
                  nudge_x = 0.25) + #Label corvette subset and nudge to match graph*
...
mpg %>% 
  ...
  geom_point(position = position_dodge2(0.8)) + #Change point overlaps
  scale_color_brewer(palette = "Set2") + #Set color palette to Brewer Set2
  geom_boxplot(color = "black", fill = NA, outlier.shape = NA) + #Removes outliers from boxplot and 
