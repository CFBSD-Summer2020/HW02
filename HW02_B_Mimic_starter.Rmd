...
type of cut quality and clarity of diamond") +
  ...
  theme(plot.title = element_text(hjust = 0.5,size=13), plot.subtitle=element_text(size=11))
...
ggplot(iris, aes(Sepal.Length,Petal.Length,color=Species,shape=Species)) +
    geom_point()+
    facet_wrap(factor(Species,levels=c("versicolor","setosa","virginica"))~.,scales="free_y")+
...
ggplot(mpg,aes(displ,hwy,label=paste(model,year,sep = ",",collapse = NULL)))+
  geom_point()+
  geom_text_repel()+
