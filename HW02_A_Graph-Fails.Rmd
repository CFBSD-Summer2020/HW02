...
**To be honest, I'm not sure if there's a better solution, but one way to avoid overlapping is by increasing the length of the ticks to move the labels below the graph lower limit.** 
