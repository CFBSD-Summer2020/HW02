...
ggplot() + 
  ...
  theme(legend.position = c(4/7,40/50))
  #theme(legend.title = element_blank()) #to remove the legend title ("class")
  #theme(legend.position = "none") #to remove the plot legend completely
