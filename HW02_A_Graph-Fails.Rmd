...
mpg %>%
  ...
  ggplot(mapping = aes(x = cty, y = hwy, color = "blue")) + #needed a + instead of a %>%
  geom_point()
...
#vjust can change the vertical justification of text. I played around with values less that 1 until it looked nice.
```
