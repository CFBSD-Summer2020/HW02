...
#theme(legend.position = "none") is used to remove the legend completely
#however, I am not sure how to put the legends at 5,40
...
ggplot(mapping = aes(x = displ, y = hwy, color = drv)) + 
  geom_point() + 
  geom_smooth(se = F, aes(color = NULL)) #se = F makes it so it won't show the error in the line of fit
