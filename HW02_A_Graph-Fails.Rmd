...
Figure3 <- mpg %>% 
ggplot() + 
  geom_point(mapping = aes(x = displ, y = hwy, color = class), size=3) #Alpha refers to the transperancy of the dot, so I changed it to size and placed it outside of the aesthetic to make it an atribute 
